...
![桌面软件界面](media/onboarding/desktop-ui.png)
...
![知识库划分](media/knowledge/overview-division.png)
...
![行业知识库界面](media/knowledge/industry-kb.png)
...
![企业知识库界面](media/knowledge/enterprise-kb.png)
...
![知识库提问界面](media/qa/ask-interface.png)
![知识库提问结果](media/qa/qa-result.png)

### 检索范围

1. 进入知识库内的文件夹，在右上方的搜索栏内输入关键词，找到目标文件。选中文件后可右键进行预览、打开（使用本地默认应用）、提问、下载和收藏等操作。

  ![关键词检索](media/search/keyword-search.png)

2. 也可以在提问页面左下角选择所需的检索范围。

  ![检索范围选择1](media/search/range-select-1.png)
  ![检索范围选择2](media/search/range-select-2.png)

![文件夹与文件列表](media/files/folders-and-files.png)

选择“文件夹 + 全部”后可浏览所有文件列表（默认仅展示文件夹列表）。

![文件列表](media/files/file-list.png)

- 对于文件，点击后将自动添加到已选择列表。
- 对于文件夹，需要先进入文件夹并点击“选择当前文件夹”。

![选择文件夹](media/files/select-folder.png)

### 提问选项

您可以在右下角找到提问控制选项。

![提问控制选项](media/qa/question-controls.png)
...
![模型选择](media/models/model-selection.png)
...
![提问回答](media/qa/answer.png)

- 将鼠标移动到 Badge 标签上，可以查看引用的文章。

  ![引用文章](media/qa/citation.png)

- 点击引用文章弹出层右侧的图标，可预览文章内容或下载附件（需具备权限）。

  ![引用文章详细](media/qa/citation-detail.png)

生成的结果和答案可以通过聊天界面下方的“下载为 DOCX”按钮导出，或直接复制到本地文件或其他工具中。

![下载结果](media/qa/download-docx.png)
