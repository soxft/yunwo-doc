...
1. 创建账户
    ...
    ![OpenRouter 注册](media/llm/openrouter/1register.png)

2. 进入 Key 页面
    登录后，点击右上角头像，选择 **API Keys** 进入 Key 管理页面。

    ![OpenRouter 进入 Key 页面](media/llm/openrouter/2keys.png)

3. 创建新的 API Key

    点击 **Create New Key** 按钮，输入 Key 名称（如 "YunwoAI"）

    ![OpenRouter 创建 API Key](media/llm/openrouter/3create.png)
